...
if (WIN32)
    ...
    include(${CMAKE_CURRENT_LIST_DIR}/gcc-win-toolchain.cmake)
else ()
    include(${CMAKE_CURRENT_LIST_DIR}/gcc-linux-toolchain.cmake)
endif ()

set(TOOLCHAIN_COMPILER_GCC_TYPE "GCC" CACHE INTERNAL "Determines the type of compiler configured with this toolchain script for the epilog")
...
set(OBJECT_GEN_FLAGS "-O0 -mthumb -fno-builtin -Wall -ffunction-sections -fdata-sections -fomit-frame-pointer -mabi=aapcs -fno-exceptions -nostartfiles -g3 -gdwarf-2 -lgcc -lc -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=hard -DTARGET_IS_TM4C123_RB1 -DPART_TM4C123GH6PM -Dgcc")
